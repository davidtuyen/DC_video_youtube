...
- Runtime tìm token và OAuth client theo thư mục cài đặt, không phụ thuộc thư mục làm việc của shortcut.
- Setup và Smart Update đóng gói `data/google_drive_client.json` để luồng xác thực Drive có thể mở trình duyệt.
...
- Build, kiểm thử E2E và publish release v1.0.18.
