...
v1.0.18 sửa bản đóng gói thiếu cấu hình OAuth Google Drive cho cả Setup và Smart Update.
...
- v1.0.18 đóng gói OAuth client của ứng dụng thành `data/google_drive_client.json`; vẫn ưu tiên và bảo toàn `data/credentials.json` tùy chỉnh của người dùng.
